...
namespace AnimationEngine.Animations {
    public class MoveForwardAnimationBehaviour : AnimationActionBehaviour {
        ...
        protected override void InternalPlay() {
            if (GamePiece != null) {
                ...
                target = source + transform.localRotation * new Vector3(0, 1); // up vector is used as starting point
                diff = target - source;
                time = 0;
            } else {
                Stop();
